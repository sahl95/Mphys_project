...
try:
    ...
    star_sys = solar_System('Exoplanets_data/HD_1605/star.csv', 'Exoplanets_data/HD_1605/planets.csv')
...
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/HD_1605')

times = np.real(times)
try:
    df = pd.read_csv('Exoplanets_data/HD_1605'+'/b_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/HD_1605'+'/c_nbody.csv')
except:
