...
try:
    ...
    star_sys = solar_System('Exoplanets_data/HD_10180/star.csv', 'Exoplanets_data/HD_10180/planets.csv')

times = np.linspace(0, 8*10**(4), 1234)+0j
    # times = np.linspace(-0, .1, 500)+0j
    # times = np.linspace(10**6, 10**10, 10000)+0j
    # times = np.logspace(6, 10, 10000)+0j
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/HD_10180')

times = np.real(times)
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/c_nbody.csv')
except:
...
ax1.plot(t, e, 'k--', label='c', linewidth=1)
...
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/d_nbody.csv')
except:
    df = pd.read_csv('d_nbody.csv')
t, e = np.array(df.Time), np.array(df.e)
# plt.figure()
ax2.plot(t, e, 'k--', label='d', linewidth=1)
...
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/e_nbody.csv')
except:
    df = pd.read_csv('e_nbody.csv')
t, e = np.array(df.Time), np.array(df.e)
# plt.figure()
ax3.plot(t, e, 'k--', label='e', linewidth=1)
...
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/f_nbody.csv')
except:
    df = pd.read_csv('f_nbody.csv')
t, e = np.array(df.Time), np.array(df.e)
# plt.figure()
ax4.plot(t, e, 'k--', label='f', linewidth=1)
...
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/g_nbody.csv')
except:
    df = pd.read_csv('g_nbody.csv')
t, e = np.array(df.Time), np.array(df.e)
# plt.figure()
ax5.plot(t, e, 'k--', label='g', linewidth=1)
...
try:
    df = pd.read_csv('Exoplanets_data/HD_10180'+'/h_nbody.csv')
except:
    df = pd.read_csv('h_nbody.csv')
t, e = np.array(df.Time), np.array(df.e)
# plt.figure()
ax6.plot(t, e, 'k--', label='h', linewidth=1)
