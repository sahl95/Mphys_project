...
try:
    ...
    star_sys = solar_System('Exoplanets_data/Wolf_1061/star.csv', 'Exoplanets_data/Wolf_1061/planets.csv')
...
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/Wolf_1061')

times = np.real(times)
try:
    df = pd.read_csv('Exoplanets_data/Wolf_1061'+'/b_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/Wolf_1061'+'/c_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/Wolf_1061'+'/d_nbody.csv')
except:
