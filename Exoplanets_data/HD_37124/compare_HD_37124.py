...
try:
    ...
    star_sys = solar_System('Exoplanets_data/HD_37124/star.csv', 'Exoplanets_data/HD_37124/planets.csv')
...
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/HD_37124')
...
try:
    df = pd.read_csv('Exoplanets_data/HD_37124'+'/c_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/HD_37124'+'/d_nbody.csv')
except:
