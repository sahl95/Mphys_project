...
try:
    ...
    star_sys = solar_System('Exoplanets_data/HD_160691/star.csv', 'Exoplanets_data/HD_160691/planets.csv')
...
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/HD_160691')

times = np.real(times)
try:
    df = pd.read_csv('Exoplanets_data/HD_160691'+'/b_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/HD_160691'+'/c_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/HD_160691'+'/d_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/HD_160691'+'/e_nbody.csv')
except:
