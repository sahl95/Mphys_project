...
try:
    ...
    star_sys = solar_System('Exoplanets_data/Kepler-79/star.csv', 'Exoplanets_data/Kepler-79/planets.csv')
...
eccs = simulate(star_sys, times, plot=False, plot_orbit=False, save=False, folder_name='Exoplanets_data/Kepler-79')

times = np.real(times)
try:
    df = pd.read_csv('Exoplanets_data/Kepler-79'+'/b_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/Kepler-79'+'/c_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/Kepler-79'+'/d_nbody.csv')
except:
...
try:
    df = pd.read_csv('Exoplanets_data/Kepler-79'+'/e_nbody.csv')
except:
