...
print(files)
n_planets = 4
colours = ['r', 'orange', 'b', 'g', 'brown']

fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')
# title = ax.set_title('3D Test')
ttl = ax.text(0, 1.05, 0, 'Time={:.2f} years'.format(t[0]), transform = ax.transAxes, va='center')
...
ani.save('Animate_solar_system/Plots/animation_rocky_best.mp4', fps=24)
# plt.show()
